...
import static com.melik.elastic.query.service.util.Constants.NA;
...
public class TwitterQueryUserJwtConverter implements Converter<Jwt, AbstractAuthenticationToken> {
    ...
    private final static String SCOPE_CLAIM = "scope";
    private final static String USERNAME_CLAIM = "preferred_username";
    private final static String DEFAULT_ROLE_PREFIX = "ROLE_";
    private final static String DEFAULT_SCOPE_PREFIX = "SCOPE_";
    private final static String SCOPE_SEPERATOR = " ";
